...
namespace RainbowMage.OverlayPlugin.MemoryProcessors.AtkStage.FFXIVClientStructs.Global.FFXIV.Client.Graphics.Physics
{

    [StructLayout(LayoutKind.Explicit, Size = 0x78)]
    public struct BoneSimulators
    {
        [FieldOffset(0x00)] public StdVector BoneSimulator_1;
        [FieldOffset(0x18)] public StdVector BoneSimulator_2;
        [FieldOffset(0x30)] public StdVector BoneSimulator_3;
        [FieldOffset(0x48)] public StdVector BoneSimulator_4;
        [FieldOffset(0x60)] public StdVector BoneSimulator_5;
    }
