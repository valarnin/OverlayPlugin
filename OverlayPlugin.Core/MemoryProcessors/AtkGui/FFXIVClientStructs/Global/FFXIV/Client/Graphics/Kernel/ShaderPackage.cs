...
namespace RainbowMage.OverlayPlugin.MemoryProcessors.AtkStage.FFXIVClientStructs.Global.FFXIV.Client.Graphics.Kernel
{
    ...
    public unsafe struct ShaderPackage
    {
        ...
        [FieldOffset(0x10)] public CVector VertexShaders; // std::vector<VertexShader*>
        [FieldOffset(0x30)] public CVector PixelShaders; // std::vector<PixelShader*>
        [FieldOffset(0x50)] public CVector ShaderNodes; // std::vector<ShaderNode*>
