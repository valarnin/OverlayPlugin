...
namespace RainbowMage.OverlayPlugin.MemoryProcessors.AtkStage.FFXIVClientStructs.Global.FFXIV.Client.Game
{
    ...
    public unsafe struct MJIManager
    {
        /// <summary>
    ...
    /// <summary>
    ///     A helper struct that wraps an array of struct s for <see cref="MJIBuildingPlacement"/>.
    /// </summary>
    ...
    /// <summary>
    ///     A helper struct that wraps an array of struct s for <see cref="MJILandmarkPlacement"/>.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Size = Size)]
